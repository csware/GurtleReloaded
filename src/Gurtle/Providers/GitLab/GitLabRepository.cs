...
// Copyright (c) 2011, 2015 Sven Strickroth. All rights reserved.
...
namespace Gurtle.Providers.GitLab
{
    ...
    internal class GitLabRepository : IProvider
    {
        ...
        public GitLabRepository(string projectName)
        {
        ...
        {
            Debug.Assert(ProjectName != null);
            return new Uri("https://gitlab.com/api/v3/projects/" + "209220" + "/issues?private_token=XXX");
        }

        private Uri FormatUrl(string relativeUrl)
        {
            Debug.Assert(ProjectName != null);
            var baseUrl = new Uri("https://GitLab.com/projects/");
