...
namespace Gurtle.Providers.Trac
{
    ...
    internal static class MetaIssue
    {
        ...
        public static readonly IProperty<Issue, string> Milestone = new Property<Issue, string>(issue => ((TracIssue)issue).Milestone, (issue, value) => ((TracIssue)issue).Milestone = value);
        public static readonly IProperty<Issue, string> Priority = new Property<Issue, string>(issue => ((TracIssue)issue).Priority, (issue, value) => ((TracIssue)issue).Priority = value);
        public static readonly IProperty<Issue, string> Owner = new Property<Issue, string>(issue => ((TracIssue)issue).Owner, (issue, value) => ((TracIssue)issue).Owner = value);
        ...
        public static IProperty<Issue> GetPropertyByField(TracIssue.IssueField field)
        {
            var index = (int) field;
