namespace Gurtle.Providers.GitHub
{
    public partial class OptionsDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.TabIndex = 0;
            label1.Text = "&GitHub Repository Name:";
            // 
            // _projectNameBox
            // 
            ...
            _toolTip.SetToolTip(this._projectNameBox, "Enter GitHub repository name");
            ...
            this._linkLabel.Text = "https://www.github.com/";
            ...
            _toolTip.SetToolTip(this._testButton, "Test if the supplied GitHub repository is reachable online or not");
